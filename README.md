...
| Phase | duration MAE | skill | R² | coverage (0.80 nominal) | gate |
|-------|--------------|-------|----|-------------------------|------|
| P1HV | 3.27 mo | +0.27 | 0.324 | 0.80 | pass |
| P1 | 7.78 mo | +0.35 | 0.629 | 0.78 | pass |
| P2 | 9.46 mo | +0.22 | 0.403 | 0.80 | pass |
| P3 | 10.22 mo | +0.21 | 0.363 | 0.77 | pass |

Fold: horizon fold — train on trials starting before 2018, test on 2018–2020 starts, which have had 5.4–8.6 years to finish against a corpus whose p95 duration is 5.9. Rows P1HV=333, P1=327, P2=329, P3=330 of `experiments/ledger.jsonl`. Regenerate: `python -m experiments.publish_metrics`.
...
Reproduce: `python -m experiments.run --config two_stage_l2,two_stage_l2_cov85 --split horizon`,
then `python -m experiments.publish_metrics` to refresh this table from the ledger.
